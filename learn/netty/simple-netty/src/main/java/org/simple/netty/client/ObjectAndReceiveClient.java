...
import org.simple.netty.handler.SecObjectSendChannelHandler;

public class ObjectAndReceiveClient {
	public static void main(String[] args) throws InterruptedException {
		...
		clientBootstrap.setPipelineFactory(new ChannelPipelineFactory() {
			@Override
			public ChannelPipeline getPipeline() throws Exception {//encoder和decoder的顺序可以交换
				return Channels.pipeline(new ObjectEncoder(),
						new ObjectDecoder(),
						new ObjectSendChannelHandler(),
						new SecObjectSendChannelHandler());//handler是要有顺序的
			}
		});
		//连接到服务端
...
//		System.out.println(writeFuture.isSuccess());
//		System.out.println(writeFuture.isDone());
//		writeFuture.await();
//		System.out.println(writeFuture.isSuccess());
//		System.out.println(writeFuture.isDone());
//		System.out.println(writeFuture.getChannel().getm);//就是连接的那个chanel
//		Thread.sleep(1000l);
