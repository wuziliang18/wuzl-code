...
public class UicMainBatchTableNameUserSQL {
	public static void main(String[] args) throws Exception {
		...
		PATH_MAP.put("BEAN_PROJECT_PATH", "/home/wuzl/dayimawork/uic/uic-api");
		...
		PATH_MAP.put("DAO_PROJECT_PATH", "/home/wuzl/dayimawork/uic/uic-provider");
		...
		PATH_MAP.put("SERVICE_INTERFACES_PROJECT_PATH", "/home/wuzl/dayimawork/uic/uic-api");
		PATH_MAP.put("SERVICE_IMPL_PROJECT_PATH", "/home/wuzl/dayimawork/uic/uic-provider");
		...
		String selectSql="select table_name from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA ='dayima' and table_name like 'user_xinwo%'";
