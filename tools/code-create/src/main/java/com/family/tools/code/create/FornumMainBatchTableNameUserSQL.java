...
public class FornumMainBatchTableNameUserSQL {
	public static void main(String[] args) throws Exception {
		...
		PATH_MAP.put("BEAN_PROJECT_PATH", "/home/wuzl/dayimawork/forumapi/forum-service-api");
		...
		PATH_MAP.put("DAO_PROJECT_PATH", "/home/wuzl/dayimawork/forumapi/forum-provider");
		...
		PATH_MAP.put("SERVICE_INTERFACES_PROJECT_PATH", "/home/wuzl/dayimawork/forumapi/forum-service-api");
		PATH_MAP.put("SERVICE_IMPL_PROJECT_PATH", "/home/wuzl/dayimawork/forumapi/forum-provider");
		...
		String selectSql="select table_name from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA ='dayima' and table_name = 'topic_group_sponsorship'";
