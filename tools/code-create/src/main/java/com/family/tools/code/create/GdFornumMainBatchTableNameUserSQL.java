...
public class GdFornumMainBatchTableNameUserSQL {
	public static void main(String[] args) throws Exception {
		...
		PATH_MAP.put("BEAN_PROJECT_PATH", "/home/wuzl/dayimawork/myforum/myforum-api");
		PATH_MAP.put("BEAN_PACKAGE_PATH", "com.yoloho.myforum.service.api.model");
		PATH_MAP.put("DAO_PACKAGE_PATH", "com.yoloho.myforum.provider.dao");
		PATH_MAP.put("DAO_IMPL_PACKAGE_PATH", "com.yoloho.myforum.provider.dao.impl");
		PATH_MAP.put("DAO_PROJECT_PATH", "/home/wuzl/dayimawork/myforum/myforum-provider");
		...
		PATH_MAP.put("SERVICE_INTERFACES_PROJECT_PATH", "/home/wuzl/dayimawork/myforum/myforum-api");
		PATH_MAP.put("SERVICE_IMPL_PROJECT_PATH", "/home/wuzl/dayimawork/myforum/myforum-provider");
		PATH_MAP.put("SERVICE_PACKAGE_PATH", "com.yoloho.myforum.service.api.interfaces");
		PATH_MAP.put("SERVICE_IMPL_PACKAGE_PATH", "com.yoloho.myforum.provider.service.impl");
		...
		String selectSql="select table_name from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA ='gd_dayima' and table_name like '%topic_reply_audit%'";
