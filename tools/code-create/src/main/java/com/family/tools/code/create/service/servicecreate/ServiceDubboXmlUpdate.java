...
import com.family.tools.code.create.supports.ParamBeanUtil;
...
public class ServiceDubboXmlUpdate extends AbstractXmlFileUpdateCodeOperator {
	...
	public Document doUpdateXmlCode(ParamBean paramBean, Document doc) {
		...
		String serviceName = paramBean.getPrefix()
				...
				+ "Service";
		String refName = ParamBeanUtil.getName(paramBean,
				ConfigUtil.changeUnderLineToHump(tableName))
				+ "Service";
		...
		beanElement.setAttribute("interface", packagePath + "." + serviceName);
	...
	public void doSetFilePath(ParamBean paramBean) {
		...
		String springResourcesPath = paramBean.getPath(
				Constants.Service.SERVICE_SPRING_RESOURCES_PATH, "/");
