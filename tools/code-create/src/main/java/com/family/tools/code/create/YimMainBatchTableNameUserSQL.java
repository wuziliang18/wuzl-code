...
public class YimMainBatchTableNameUserSQL {
	public static void main(String[] args) throws Exception {
		DbConfBean bean = new DbConfBean();
		bean.setDriverClassName("com.mysql.jdbc.Driver");
		bean.setUrl("jdbc:mysql://dbserver:3306/yim?useUnicode=true&amp;characterEncoding=utf-8");
		...
		PATH_MAP.put("BEAN_PROJECT_PATH", "/home/wuzl/dayimawork/yim/yim-api");
		PATH_MAP.put("BEAN_PACKAGE_PATH", "com.yoloho.yim.api.model");
		PATH_MAP.put("DAO_PACKAGE_PATH", "com.yoloho.yim.dao");
		PATH_MAP.put("DAO_IMPL_PACKAGE_PATH", "com.yoloho.yim.dao.impl");
		PATH_MAP.put("DAO_PROJECT_PATH", "/home/wuzl/dayimawork/yim/yim-server");
		...
		PATH_MAP.put("SERVICE_INTERFACES_PROJECT_PATH",
				"/home/wuzl/dayimawork/yim/yim-api");
		PATH_MAP.put("SERVICE_IMPL_PROJECT_PATH",
				"/home/wuzl/dayimawork/yim/yim-server");
		PATH_MAP.put("SERVICE_PACKAGE_PATH", "com.yoloho.yim.api.interfaces");
		PATH_MAP.put("SERVICE_IMPL_PACKAGE_PATH", "com.yoloho.yim.service.impl");
		...
		String selectSql = "select table_name from INFORMATION_SCHEMA.TABLES where TABLE_SCHEMA ='yim' and table_name like 'yim_user_extra%'";
