...
public class ConfigUtil {
	...
	public static String changeUnderLineToHumpAndFontUp(String oldName) {
		...
		humpName = humpName.substring(0, 1).toUpperCase()
				+ humpName.substring(1, humpName.length());
		return humpName;
	}
	...
	public static String changeFirstToUp(String oldText) throws Exception {
		...
		return firstLetter.toUpperCase()
				+ oldText.substring(1, oldText.length());
	}

	public static String changeFirstToUpNoCheck(String oldText) {
		if (StringUtil.isBlank(oldText)) {
			return "";
		}
		String firstLetter = oldText.substring(0, 1);
	...
	public static void main(String[] args) {
		System.out.println(ConfigUtil
				.changeUnderLineToHumpAndFontUpOtherLower("asdfGFSADF_ASD"));
		;
		System.out.println(ConfigUtil
				.changePackageToRelativePath("com.family.util"));
		;
	}
}
