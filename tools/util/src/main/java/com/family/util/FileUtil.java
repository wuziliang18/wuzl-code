...
public class FileUtil {
	 ...
	 * @comment
	 */
	public static boolean validateDirectoryHave(String filePath)
		...
		String directoryPath = filePath.substring(0,
				filePath.lastIndexOf(breakSign));
	 ...
	 * @throws RuntimeException
	 */
	public static boolean validateFileOrDirectoryHave(String filePath)
			throws RuntimeException {
	 ...
	 * @comment
	 */
	public static List<File> getPathAllFileListByFileSuffixIgnoreCase(
			File upFilePath, String fileSuffix) {
		List<File> filelList = new ArrayList<File>();
		if (upFilePath.isFile()) {
			/* 1.如果指定路径是文件，并且后缀正确 */
			...
			for (File file : listFiles) {
				if (file.isFile()) {
					...
					filelList.addAll(getPathAllFileListByFileSuffixIgnoreCase(
							file, fileSuffix));
				}
			}
		}
	...
	public static void createNewFile(String filePath) {
		...
		try {
			...
			throw new RuntimeException("新建文件【" + filePath + "】失败："
					+ e.getMessage());
		}
	}
	...
	public static void createNewFile(File newFile) {
		...
		try {
			...
			throw new RuntimeException("新建文件【" + newFile.getPath() + "】失败："
					+ e.getMessage());
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		// List<File>
		// fileList=FileUtil.getPathAllFileListByFileSuffixIgnoreCase(new
		// File(filePath),"java");
		// for(File file:fileList){
		// System.out.println(file.getName());
		// }
		// System.out.println(FileUtil.checkFileSuffixIgnoreCase(new
		// File("E:/workspace/util/src/main/java/com/family/util/Constants.Java"),
		// "java"));
		System.out
				.println(getFileContent("/home/wuzl/桌面/WuzlStartService.java"));
