...
public class DateFormatExpressionFunction extends ExpressionFunctionAdapter {
    @Override
    ...
    public String doConver(List<ExpressionNode> nodes) {
        ...
        sb.append(" DATE_FORMAT(").append(nodes.get(0).getValue()).append(" , ").append(nodes.get(1).getValue())
                .append(")");
        return sb.toString();
    }
}
