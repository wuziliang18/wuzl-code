...
public class NotBetweenExpressionFunction extends ExpressionFunctionAdapter {
    @Override
    ...
    public String doConver(List<ExpressionNode> nodes) {
        ...
        sb.append(" NOT BETWEEN ").append(nodes.get(0).getValue()).append(" AND  ").append(nodes.get(1).getValue());
        return sb.toString();
    }
}
