...
public class ExpressionConverterTest {
    public static void main(String[] args) {
        ...
        List<String> list = Arrays.asList("#STR_LENGTH(\"测试中文123\")", "$a #substr(\"abc\",0,2)",
                "$a #SUBSTR(\"abc\",0,2)", "$a #LIKE(\"a\") and $b=1", "$a #IN(1)", "$a #IN(1,2)", "true and $a==1",
                "$a == null and $b.c!=null", "1+2+#IF_NULL($a.d,112)", "#CONCAT(\"hello\",\"world\")", "3    * 5",
                ...
                "#IF($a==1 and $b.a==null) $a.b1*3+#IF_NULL($a.n+#CURRENT_DATE(),$b) #ELSE #CONCAT(1+$a+$b+121.1,\"111ss.xx\") #END_IF"
                        + "");
