...
public class StrToDateExpressionFunction extends ExpressionFunctionAdapter {
    @Override
    ...
    public String doConver(List<ExpressionNode> nodes) {
        ...
        sb.append(" STR_TO_DATE(").append(nodes.get(0).getValue()).append(" , ").append(nodes.get(1).getValue())
                .append(")");
        return sb.toString();
    }
}
