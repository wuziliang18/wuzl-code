...
public class FileUtil {
    ...
    public static boolean writeFile(String msg, String fileName, boolean checkFileHave) {
        ...
        return writeFile(msg, file, checkFileHave);
    }
     ...
     * @return
     */
    public static boolean writeFile(String msg, File file, boolean checkFileHave) {
        ...
        try {
            ...
            write = new OutputStreamWriter(outSTr, "utf-8");
            write.write(msg);
    ...
    public static void main(String[] args) throws Exception {
        ...
        // File("E:/workspace/util/src/main/java/com/family/util/Constants.Java"), "java"));
