...
public class TestInvocationHandler implements InvocationHandler {
    ...
    public static void main(String[] args) {
        ...
        // IWorkService proxy = (IWorkService) Proxy.newProxyInstance(TestInvocationHandler.class.getClassLoader(),
        // new Class[] { IWorkService.class }, new TestInvocationHandler(work));
        // proxy.work("尝试下代理");

//        WorkServiceImpl proxy = (WorkServiceImpl) Proxy.newProxyInstance(TestInvocationHandler.class.getClassLoader(),
//                new Class[] { WorkServiceImpl.class }, new TestInvocationHandler(work));
//        proxy.work("尝试下代理");
    }
}
